    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (formaPago.Equals(" tarjeta "))
            {
                ...
                Console.WriteLine(" El producto con precio " + precio  + " se ha pagado con el número de tarjeta " + numero_tarjeta);
            }
            ...
            else 
            {
                ...
                Console.WriteLine(" No es un método de pago correcto ");
            }
